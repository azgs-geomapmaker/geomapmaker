...
namespace Geomapmaker.Data
{
    public class ContactsAndFaults
    {
        ...
        public static async Task<List<ValidationRule>> GetValidationResultsAsync()
        {
            ...
            if (await FeatureLayers.FeatureLayerExistsAsync("MapUnitPolys") == false)
            {
            ...
            else // Table was found
            {
                ...
                //
                int tableCount = FeatureLayers.FeatureLayerCount("MapUnitPolys");
                if (tableCount > 1)
                {
                ...
                List<string> missingFields = await FeatureLayers.FeatureLayerGetMissingFieldsAsync("ContactsAndFaults", cfRequiredFields);
                ...
                List<string> fieldsWithMissingValues = await FeatureLayers.FeatureLayerGetRequiredFieldIsNullAsync("ContactsAndFaults", cfNotNullFields);
                ...
                //
                List<string> duplicateLabels = await FeatureLayers.FeatureLayerGetDuplicateValuesInFieldAsync("ContactsAndFaults", "Label");
                ...
                //
                List<string> duplicateIds = await FeatureLayers.FeatureLayerGetDuplicateValuesInFieldAsync("ContactsAndFaults", "ContactsAndFaults_ID");
        ...
        public static async Task<List<UndefinedTerm>> GetTermsUndefinedInGlossaryAsync(List<string> definedTerms)
        {
            ...
            List<string> TypeTerms = await FeatureLayers.FeatureLayerGetDistinctValuesForFieldAsync("ContactsAndFaults", "Type");
            ...
            List<string> ExistenceConfidenceTerms = await FeatureLayers.FeatureLayerGetDistinctValuesForFieldAsync("ContactsAndFaults", "ExistenceConfidence");
            ...
            List<string> IdentityConfidenceTerms = await FeatureLayers.FeatureLayerGetDistinctValuesForFieldAsync("ContactsAndFaults", "IdentityConfidence");
